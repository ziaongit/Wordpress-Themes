	...
	public static function init() {
		...
		self::$fields = array(
			array(
				...
				'description' => sprintf( __( '%1\$sClick here%2\$s to get the icon class name', 'mk_framework' ), "<a target='_blank' href='" . admin_url( 'admin.php?page=Jupiter#mk-cp-icon-library' ) . "'>", '</a>' ),
			),
			array(
				'key'         => 'megamenu',
				'type'        => 'checkbox',
