(function($) {
     ...
     * WPML
     */
    var $hb_lang_item = $('.hb-navigation > .hb-navigation-ul > .menu-item-language');
    $hb_lang_item.addClass('hb-no-mega-menu').css('visibility', 'visible');
    $('.hb-navigation .menu-item-language > a').addClass('menu-item-link');

    /**
     * Assign header builder navigation click handlers
     */
    $( document ).on( 'click', '.hb-js-smooth-scroll, .hb-js-nav a', smoothScrollToAnchor);
    ...
    $( '.menu-item-has-children.hb-no-mega-menu' ).hover( function(){
